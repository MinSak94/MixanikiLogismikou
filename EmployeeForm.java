		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (passingvar.mode == "CR") {
					if (idtext.getText().isEmpty() || ftext.getText().isEmpty() || ltext.getText().isEmpty()
							|| postext.getText().isEmpty() || mailtext.getText().isEmpty()
							|| phonetext.getText().isEmpty() || addresstext.getText().isEmpty()
							|| wagetext.getText().isEmpty() || yictext.getText().isEmpty()) {
						JOptionPane.showInternalOptionDialog(frame.getContentPane(), Title[1], Title[0], 0, messageType,
								null, options, null);
						return;
					}
					try {
						sqls.EmployeeCreateAction(idtextS, ftextS, ltextS, depcomboS, postextS, mailtextS, phonetextS,
								addresstextS, wagetextS, yictextS);
					...
					try {
						sqls.EmployeeEditAction(idtextS, ftextS, ltextS, depcomboS, postextS, mailtextS, phonetextS,
								addresstextS, wagetextS, yictextS, EmpId);
						JOptionPane.showMessageDialog(null, "Changes have been successfully saved!!!");
						frame.dispose();
					} catch (Exception er) {
