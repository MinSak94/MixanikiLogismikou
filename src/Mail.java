...
public class Mail {
	...
	public static void generateAndSendEmail(String mail, String username, String password)
		...
		String email = "Username: " + username + "<br>" + "Password: " + password
				+ "<br><br> Regards, <br>THE DEVs : Mhnas Saker, Vaggelis Kallipolitis, Thanos Papakwnstantinou";
