...
public class AfterLoginForm {
	...
	public void initialize() {
		...
		DelBtn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					int code = JOptionPane.showInternalOptionDialog(frmHumanResourcesManagement.getContentPane(),
							Title[1], Title[0], 0, messageType, null, options, null);
					if (code == 0) {
		...
		DelBtn2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					int code = JOptionPane.showInternalOptionDialog(frmHumanResourcesManagement.getContentPane(),
							Title[2], Title[0], 0, messageType, null, options, null);
					if (code == 0) {
		...
		DelBtn3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					int code = JOptionPane.showInternalOptionDialog(frmHumanResourcesManagement.getContentPane(),
							Title[3], Title[0], 0, messageType, null, options, null);
					if (code == 0) {
