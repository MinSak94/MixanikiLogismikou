...
public class SqlStatements {
	...
	public boolean LoginAction(String username, String password, String job) throws SQLException, Exception {
		...
		if (job == "Manager") {
			...
			sql = "SELECT * FROM login WHERE Username = '" + username + "'AND Password = '" + password + "'AND Job = '"
					+ job + "'";
		}
	...
	public boolean DepartmentEditAction(String First, String Second, String title1, String loc1, String dec1,
			String MngCombo, String sqltitle) throws SQLException, Exception {
		boolean res = false;
		...
		String sql8 = "UPDATE manager SET DepId='" + title1 + "'" + " WHERE username ='" + DepMngId + "'";
	...
	public boolean DepartmentCreate(String First, String titletext, String loctext, String dectext, String MngCombo)
			throws SQLException, Exception {
		String sql7 = "INSERT INTO department (Title,Location,Description,MngId) VALUES " + "('" + titletext + "','"
				+ loctext + "','" + dectext + "','" + MngCombo + "')";
		PreparedStatement pre5 = null;
	...
	public boolean EmployeeCreateAction(String idtext, String ftext, String ltext, String depcombo, String postext,
			String mailtext, String phonetext, String addresstext, String wagetext, String yictext)
			throws SQLException, Exception {
		String sql2 = "INSERT INTO employees (id,fname,lname,dep,pos,mail,phone,address,wage,yic) VALUES ('" + idtext
				+ "','" + ftext + "','" + ltext + "','" + depcombo + "','" + postext + "','" + mailtext + "','"
				+ phonetext + "','" + addresstext + "','" + wagetext + "','" + yictext + "')";
		PreparedStatement pre = null;
		System.out.println(sql2);
		pre = connsql.getConnection().prepareStatement(sql2);
	...
	public boolean EmployeeEditAction(String idtext, String ftext, String ltext, String depcombo, String postext,
			String mailtext, String phonetext, String addresstext, String wagetext, String yictext, String EmpId)
			throws SQLException, Exception {
		String sql3 = "UPDATE employees SET id='" + idtext + "',fname='" + ftext + "',lname='" + ltext + "',dep='"
				+ depcombo + "',pos='" + postext + "',mail='" + mailtext + "',phone='" + phonetext + "',address='"
				+ addresstext + "',wage='" + wagetext + "',yic='" + yictext + "' WHERE id='" + EmpId + "'";
		PreparedStatement pre1 = null;
		pre1 = connsql.getConnection().prepareStatement(sql3);
	...
	public boolean ManagerAction(String ftext, String ltext, String wagetext, String mailtext, String addresstext,
			String phonetext, String usertext, String passtext) throws SQLException, Exception {
		String sql = "INSERT INTO manager (fname,lname,wage,mail,address,phone,username,password) " + "VALUES ('"
				+ ftext + "','" + ltext + "','" + wagetext + "'" + ",'" + mailtext + "','" + addresstext + "','"
				+ phonetext + "'" + ",'" + usertext + "','" + passtext + "')";
		PreparedStatement pre = null;
		pre = connsql.getConnection().prepareStatement(sql);
	...
	public ResultSet SearchEmployee(String id, String fname, String lname, String dep, String pos, String mail,
			String phone, String address, String wage, String yic) throws SQLException, Exception {
	...
	public boolean SignUpFormActions(String username, String password, String mailtext) throws SQLException, Exception {
		String sql = "INSERT INTO login (Job,Username,Password,Email) VALUES " + "('Manager','" + username + "','"
				+ password + "','" + mailtext + "')";
	...
	public ResultSet ValuationCreate() throws SQLException, Exception {
		String sql3 = "SELECT id  FROM employees WHERE id NOT IN (SELECT id FROM valuation)";// INNER
																								// JOIN
																								// valuation
																								// ON
																								// valuation.id
	...
	public boolean ValuationCreateAction(String id, int prod, int comm, int cap, int org, int team, int adap, int dedic,
			String mode) throws SQLException, Exception {
		if (mode == "CR") {

			String sql1 = "INSERT INTO valuation (id,prod,comm,cap,org,team,adap,dedic) " + "VALUES ('" + id + "','"
					+ prod + "','" + comm + "','" + cap + "','" + org + "','" + team + "'" + ",'" + adap + "','" + dedic
					+ "')";
			PreparedStatement pre = null;
			pre = connsql.getConnection().prepareStatement(sql1);
			int result1 = pre.executeUpdate();
			...
			String sql3 = "UPDATE valuation SET prod='" + prod + "',comm='" + comm + "',cap='" + cap + "'" + ",org='"
					+ org + "',team='" + team + "',adap='" + adap + "',dedic='" + dedic + "' " + "WHERE id='" + id
					+ "'";
			PreparedStatement pre1 = null;
			pre1 = connsql.getConnection().prepareStatement(sql3);
			int result2 = pre1.executeUpdate();
