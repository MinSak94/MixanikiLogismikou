...
public class Registration {
	...
	private void initialize() {
		...
		if (language == "GR") {
			...
			lblAuth.setText(
					"<html><u>Οδηγείες</u><br>Παρακαλώ συμπληρώστε την φόρμα με το όνομα χρήστη και τον κωδικό που παραλάβατε στο email σας</html>");
		} else {
			...
			lblAuth.setText(
					"<html><u>Instructions</u><br>Please fill the form with the username and password you received in you email. </html>");
		}
		// -----------------------------------------------------------------------
	}
}
