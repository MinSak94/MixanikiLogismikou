		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					list.removeAll();
					list.add(listres);
					ResultSet result1 = sqls.SearchEmployee(idtext.getText(), ftext.getText(), ltext.getText(),
							deptext.getText(), postext.getText(), mailtext.getText(), phtext.getText(),
							adtext.getText(), wgtext.getText(), yictext.getText());
					while (result1.next()) {
