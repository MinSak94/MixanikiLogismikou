...
public class ValuationForm {
	...
	private void initialize() {
		...
		if (var.language == "GR") {
			...
			lblChooseEmplyee.setText("Choose EmplÎ¿yee");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					sqls.ValuationCreateAction(list.getSelectedItem(), comboBox.getSelectedIndex(),
							comboBox_1.getSelectedIndex(), comboBox_2.getSelectedIndex(), comboBox_3.getSelectedIndex(),
							comboBox_4.getSelectedIndex(), comboBox_5.getSelectedIndex(), comboBox_6.getSelectedIndex(),
							var.mode);
