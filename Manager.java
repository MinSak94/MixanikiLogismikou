	...
	private void initialize() {
		...
		sbmbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					sqls.ManagerAction(ftext.getText(), ltext.getText(), wagetext.getText(), mailtext.getText(),
							addresstext.getText(), phonetext.getText(), usertext.getText(), passtext.getText());
